...
namespace StylizedWater2
{
    ...
    public class WaterObject : MonoBehaviour
    {
        ...
        /// <summary>
        /// Any properties applied to the MaterialPropertyBlock are applied. Currently used by the Planar Reflections feature
        /// </summary>
        ...
        /// <summary>
        /// Checks if the position is below the maximum possible wave height. Can be used as a fast broad-phase check, before actually using more expensive buoyancy calculations
        /// </summary>
        ...
        public static WaterObject New()
        {
            ...
            waterObject.material = waterObject.meshRenderer.sharedMaterial;
